...
export class LogComponent implements OnInit {
  ...
  exportReportPermission: boolean = false;
  getPermission() {
    this.exportReportPermission = this._GuardService.getPermissionStatus('export_AgentReport');
  }
  ...
  export(data: any, type: string) {
    if (this.exportReportPermission) {
