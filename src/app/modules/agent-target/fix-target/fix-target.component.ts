...
@Component({
  ...
  styleUrls: ['./fix-target.component.scss']
})

export class FixTargetComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this._AgentTargetService.currentFixedTarget
  ...
  createUpdateForm() {
    this.updateForm = new FormGroup({
      client_number: new FormControl({ value: null, disabled: true }, [
        Validators.required,
        Validators.pattern('^[\\d]{10}$'),
      ]),
      customer_type: new FormControl({ value: null, disabled: true }, [Validators.required]),
      paid_by: new FormControl({ value: null, disabled: true }, [Validators.required]),
      invoice_number: new FormControl({ value: null, disabled: true }, [Validators.required]),
      ...
      team: new FormControl({ value: null, disabled: true }, [Validators.required]),
      amount_paid: new FormControl({ value: null, disabled: true }, [Validators.required]),
      client_name: new FormControl({ value: null, disabled: true }, [Validators.required]),
