...
export class ShowSubscriptionComponent implements OnInit, OnDestroy {
  ...
  // ======================================================================================================================
  printAccountantTaxInvoice(sub: any) {
    if (this.printPermission) {
      const doc = new jsPDF();
      const imageFile = '../../../../assets/images/logo.png';
      // =================================LINES=================================
      ...
      doc.setDrawColor(187, 187, 187); // RGB color values (black in this case)
      doc.setLineWidth(0.4); // Set the line width
      doc.line(18, 75, 18, 130); // (x1, y1, x2, y2) Vertical
      doc.line(45, 75, 45, 130); // (x1, y1, x2, y2) Vertical
      doc.line(90, 75, 90, 130); // (x1, y1, x2, y2) Vertical
      doc.line(105, 75, 105, 130); // (x1, y1, x2, y2) Vertical
      doc.line(120, 75, 120, 130); // (x1, y1, x2, y2) Vertical
      doc.line(143, 75, 143, 130); // (x1, y1, x2, y2) Vertical
      doc.line(157, 75, 157, 130); // (x1, y1, x2, y2) Vertical
      doc.line(175, 75, 175, 130); // (x1, y1, x2, y2) Vertical
      // =================================END-LINE=================================
      doc.line(10, 82, 200, 82); // (x1, y1, x2, y2) Horizontal
      doc.line(10, 130, 200, 130); // (x1, y1, x2, y2) Horizontal
      doc.line(10, 175, 200, 175); // (x1, y1, x2, y2) Horizontal
      doc.line(10, 185, 200, 185); // (x1, y1, x2, y2) Horizontal
      ...
      // =================================END-LINE=================================
      doc.line(125, 130, 125, 175); // (x1, y1, x2, y2) Vertical
      doc.line(125, 185, 125, 285); // (x1, y1, x2, y2) Vertical
      doc.line(163, 185, 163, 218); // (x1, y1, x2, y2) Vertical
      // =================================END-LINE=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      ...
      doc.setFontSize(9);
      doc.text('TOTAL COST OF FOOD', 47, 90);
      doc.text('SOLD FOR THE PERIOD', 47, 95);
      doc.text('01/03/23 - 01/03/23', 47, 100);
      ...
      doc.setFontSize(9);
      doc.text('26,287.54', 178, 90);
      // =================================END-TEXT=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('Notes : Thanks for your business.', 13, 138);
      doc.setFont('helvetica', 'normal'); // Set font and style to bold
      doc.text('Sub Total', 127, 138);
      doc.text('22,55.65', 170, 138);
      doc.text('Standard Rate (5%)', 127, 146);
      doc.text('13,74.66', 170, 146);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.text('Total', 127, 154);
      doc.text('AED 22,26.55', 170, 154);
      doc.text('Balance Due', 127, 162);
      doc.text('AED 22,22.55', 170, 162);
      // =================================END-TEXT=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('Tax Summary', 13, 181);
      // =================================END-TEXT=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('Tax Details', 13, 193);
      doc.setFontSize(9);
      doc.text('Taxable Amount (AED)', 127, 193);
      doc.text('Tax Amount (AED)', 165, 193);
      // =================================END-TEXT=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'normal'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('Standard Rate (5%)', 13, 204);
      doc.text('26,55.33', 128, 204);
      doc.text('26,55.33', 165, 204);
      // =================================END-TEXT=================================
      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('Total', 13, 214);
      doc.text('AED 26,55.33', 128, 215);
      doc.text('AED 26,55.33', 165, 215);
      // =================================END-TEXT=================================
      doc.setFontSize(9);
      doc.setFont('helvetica', 'normal'); // Set font and style to bold
      doc.setTextColor('#1f1f1f'); // Set text color to black
      doc.text('BANK ACCOUNT DETAILS BANK NAME: ADIB (Abu Dhabi Islamic Bank)', 13, 225);
